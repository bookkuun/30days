...
class ChallengeController extends Controller
{
    public function store(ChallengeRequest $request)
    {
        ...
        return redirect(route('users.show', Auth::id()))->with('message', 'Challengeを設定しました');
    }
    ...
    public function update(ChallengeRequest $request)
    {
        ...
        return redirect(route('users.show', Auth::id()))->with('message', 'Challengeを編集しました');
    }
    ...
    public function destroy($challenge_id)
    {
        ...
        return redirect(route('users.show', Auth::id()))->with('message', 'Challengeをやめました');
    }
}
